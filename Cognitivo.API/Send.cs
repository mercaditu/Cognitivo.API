...
//        public object Item(List<APIModel.Item> Items)
//        {
//            object json;
...
//        /// <returns>List of Items with information of successful sync.</returns>
//        /// <param name="Items">List of Items.</param>
//        public List<APIModel.ResponseCustomer> Customer(List<APIModel.Customer> Items)
//        {
...
//            //List<APIModel.ResponseCustomer> ResponseCustomers = new List<Models.ResponseCustomer>();
//            //if (httpResponse.StatusCode == HttpStatusCode.OK)
//            //{
...
//            //        ResponseCustomers = service.ReadObject(stram) as List<APIModel.ResponseCustomer>;
//            //        ms.Close();
...
//        public List<APIModel.ResponseInvoice> Customer(List<Models.Invoice> Invoices)
//        {
//            MemoryStream ms = new MemoryStream();
//            DataContractJsonSerializer ser = new DataContractJsonSerializer(typeof(Models.Customer));
